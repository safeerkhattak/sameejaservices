...
export default async function ProductsPage() {
  ...
  return (
    <div className="mx-auto w-full max-w-[1280px] px-5 py-7 sm:px-8 lg:px-10 lg:py-9">
      <PageHeading eyebrow="Invoice setup" title="Products" description="Manage the articles available on invoices. Codes, unit and default rate are copied into each invoice line for a reliable historical record." />
